...
public class EditLoadoutScreen extends Screen { //I do not recommend acknowleding anything here as 'best practice.' It just works.
    ...
    public EditLoadoutScreen(LoadoutConfiguration providedLoadout, boolean fromSecondary) { //From the 'new loadout' or 'configure loadout' buttons.
        super(Text.translatable("screen.diorite.edit_loadout"));
    ...
    public void renderBackground(MatrixStack matrices) {
        ...
        //Now drawing text.
        this.textRenderer.draw(matrices, Text.translatable("option.diorite.name"),(this.width-this.backgroundWidth)/(float)2+10, (this.height-this.backgroundWidth)/(float)2+75, 0xFF000000);
        this.textRenderer.draw(matrices, Text.translatable("option.diorite.building_blocks"), (this.width-this.backgroundWidth)/(float)2+10, (this.height-this.backgroundWidth)/(float)2+111, 0xFF000000);
        this.textRenderer.draw(matrices, Text.translatable("option.diorite.id"), (this.width-this.backgroundWidth)/(float)2+10, (this.height-this.backgroundWidth)/(float)2+147, 0xFF000000);
    ...
    private void initWidgets() {
        ...
        editFiltersButton = new TexturedButtonWidget((this.width-this.backgroundWidth)/2+8, (this.height-this.backgroundWidth)/2+34,
            ...
            public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
                ...
                Text text = Text.translatable("screen.diorite.edit_loadout_filters");
        ...
        saveButton = new TexturedButtonWidget(this.width/2-22, (this.height+this.backgroundHeight)/2-30, 20, 20, 216, 0, 20, new Identifier("diorite", "gui/icons.png"), (PressAction) -> {
            ...
            public void renderTooltip(MatrixStack matrixStack, int i, int j) {
                EditLoadoutScreen.this.renderTooltip(matrixStack, Text.translatable("tooltip.diorite.save"), i, j);
            }
        };
        ...
        nameTextField = new TextFieldWidget(textRenderer, ((this.width + this.backgroundWidth)/2)-72, ((this.height - this.backgroundHeight)/2)+53, 64, 18, Text.translatable("widgets.diorite.name"));
        ...
        buildingBlocksTextField = new TextFieldWidget(textRenderer, ((this.width + this.backgroundWidth)/2)-72, ((this.height - this.backgroundHeight)/2)+89, 64, 18, Text.translatable("widgets.diorite.building_blocks"));
        ...
        idTextField = new TextFieldWidget(textRenderer, ((this.width + this.backgroundWidth)/2)-72, ((this.height - this.backgroundHeight)/2)+125, 64, 18, Text.translatable("widgets.diorite.id"));
